                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img id="imgview" height="150px" width="100px" src="book_inventory/b1.jpg" />
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button CssClass="form-control btn btn-primary" ID="Button5" runat="server" Text="Go" OnClick="Button5_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-9">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:DropDownList CssClass="form-control" ID="DropDownList" runat="server">
                                        ...
                                        <asp:ListItem Text="Enlgish" Value="English"></asp:ListItem>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox8" runat="server" placeholder="Issued Stock" TextMode="Number" ReadOnly="True"></asp:TextBox>
